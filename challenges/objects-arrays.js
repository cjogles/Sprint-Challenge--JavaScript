...
let tyrannosaurus= {name: "tyrannosaurs", diet: "carnivorous", weight: "7000kg", length: "12m", period: "Late Cretaceous", roar() {return "RAWERSRARARWERSARARARRRR!"}}; 
// stegosaurus, herbivorous, 2000kg, 9m, Late Jurassic
let stegosaurus= {name: "stegosaurus", diet: "herivorous", weight: "2000kg", length: "9m", period: "Late Jurassic"}; 
...
// Given this zoo data from around the United States, follow the instructions below.  Use the specific array methods in the requests below to 
// solve the problems.
...
using the .reduce() method. Remember the reduce method takes two arguments: a callback (which itself takes two args), 
